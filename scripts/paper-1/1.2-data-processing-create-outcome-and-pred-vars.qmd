...
system.time(
  df_psu_tmax_tmin_temp_vars_added <- df_psu_tmax_tmin[, hotday_35 := ifelse(max_temp > 35, 1, 0)
      ...
      , num_consec_long_avg_tmin_5 := ifelse(consec_days_lt_avg_tmin > 5, 1, 0), by = psu
      ]
)
beep(sound = 3)
```
...
df_psu_tmax_tmin_2022_psu <- df_psu_tmax_tmin_2022[,
                  .(lat = first(lat),
                    ...
                    tmax_long_term_avg_tmax = mean(long_term_avg_tmax),
                    num_hotday_long_avg_tmax = sum(hotday_long_avg_tmax),
